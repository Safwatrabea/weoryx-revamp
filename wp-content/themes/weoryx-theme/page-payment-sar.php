<?php
/**
 * Template Name: Payment - SAR (Stripe)
...
?>
<section class="payment-page payment-sar" id="paymentSection" dir="<?php echo $direction; ?>">
    <div class="payment-layout">
        ...
        <div class="payment-panel-left">
            ...
            <h2 class="pay-panel-title"><?php echo weoryx_translate('Secure Payment'); ?><br><span><?php echo weoryx_translate('SAR'); ?></span></h2>
        ...
        <div class="payment-panel-right">
            <div class="pay-form-wrap">
                ...
                <form id="paymentForm" novalidate>
                    ...
                    <div class="pay-form-group">
                        <label for="pay_amount"><i class="fas fa-coins"></i> <?php echo weoryx_translate('Amount (SAR)'); ?></label>
                        <div class="pay-amount-wrap <?php echo ($direction === 'rtl' ? 'pay-amount-rtl' : ''); ?>">
                            <span class="pay-currency-sym"><?php echo ($direction === 'rtl' ? 'ر.س' : 'SAR'); ?></span>
                    ...
                    <div class="pay-order-summary" id="orderSummary" style="display:none;">
                        ...
                        <div class="pay-order-row">
                            ...
                            <span id="summaryAmt" class="pay-order-amount">0.00 <?php echo ($direction === 'rtl' ? 'ر.س' : 'SAR'); ?></span>
                        </div>
                        <div class="pay-order-row pay-order-total">
                            <span><?php echo weoryx_translate('Total'); ?></span>
                            <span id="summaryTotal">0.00 <?php echo ($direction === 'rtl' ? 'ر.س' : 'SAR'); ?></span>
                        </div>
                    </div>
